...
namespace CrazyEaters.Tools
{
   ...
   public class LineRenderer
   {
      ...
      public LineRenderer(Node parent, Camera camera, int cornerSmooth, int jointSmooth, Shader shader = null)
      {
         material = new ShaderMaterial();
         material.SetShader(shader != null ? shader : ResourceLoader.Load(@"assets/shader/line_renderer.tres") as Shader);
